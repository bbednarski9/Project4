...
// 
// Generated using ACDS version 14.0 200 at 2016.02.16.11:55:44
...
module nios_system_mm_interconnect_0 (
	...
	wire  [89:0] rsp_mux_src_data;                                                                   // rsp_mux:src_data -> nios2_qsys_0_instruction_master_agent:rp_data
	wire   [4:0] rsp_mux_src_channel;                                                                // rsp_mux:src_channel -> nios2_qsys_0_instruction_master_agent:rp_channel
	...
	wire  [89:0] rsp_mux_001_src_data;                                                               // rsp_mux_001:src_data -> nios2_qsys_0_data_master_agent:rp_data
	wire   [4:0] rsp_mux_001_src_channel;                                                            // rsp_mux_001:src_channel -> nios2_qsys_0_data_master_agent:rp_channel
	...
	wire  [89:0] cmd_mux_src_data;                                                                   // cmd_mux:src_data -> nios2_qsys_0_jtag_debug_module_agent:cp_data
	wire   [4:0] cmd_mux_src_channel;                                                                // cmd_mux:src_channel -> nios2_qsys_0_jtag_debug_module_agent:cp_channel
	...
	wire  [89:0] cmd_mux_001_src_data;                                                               // cmd_mux_001:src_data -> onchip_memory2_0_s1_agent:cp_data
	wire   [4:0] cmd_mux_001_src_channel;                                                            // cmd_mux_001:src_channel -> onchip_memory2_0_s1_agent:cp_channel
	...
	wire  [89:0] cmd_mux_002_src_data;                                                               // cmd_mux_002:src_data -> switches_s1_agent:cp_data
	wire   [4:0] cmd_mux_002_src_channel;                                                            // cmd_mux_002:src_channel -> switches_s1_agent:cp_channel
	...
	wire  [89:0] cmd_mux_003_src_data;                                                               // cmd_mux_003:src_data -> LEDs_s1_agent:cp_data
	wire   [4:0] cmd_mux_003_src_channel;                                                            // cmd_mux_003:src_channel -> LEDs_s1_agent:cp_channel
	...
	wire  [89:0] cmd_mux_004_src_data;                                                               // cmd_mux_004:src_data -> jtag_uart_0_avalon_jtag_slave_agent:cp_data
	wire   [4:0] cmd_mux_004_src_channel;                                                            // cmd_mux_004:src_channel -> jtag_uart_0_avalon_jtag_slave_agent:cp_channel
	...
	wire  [89:0] nios2_qsys_0_instruction_master_agent_cp_data;                                      // nios2_qsys_0_instruction_master_agent:cp_data -> router:sink_data
	...
	wire  [89:0] nios2_qsys_0_data_master_agent_cp_data;                                             // nios2_qsys_0_data_master_agent:cp_data -> router_001:sink_data
	...
	wire  [89:0] nios2_qsys_0_jtag_debug_module_agent_rp_data;                                       // nios2_qsys_0_jtag_debug_module_agent:rp_data -> router_002:sink_data
	...
	wire  [89:0] onchip_memory2_0_s1_agent_rp_data;                                                  // onchip_memory2_0_s1_agent:rp_data -> router_003:sink_data
	...
	wire  [89:0] switches_s1_agent_rp_data;                                                          // switches_s1_agent:rp_data -> router_004:sink_data
	...
	wire  [89:0] leds_s1_agent_rp_data;                                                              // LEDs_s1_agent:rp_data -> router_005:sink_data
	...
	wire  [89:0] jtag_uart_0_avalon_jtag_slave_agent_rp_data;                                        // jtag_uart_0_avalon_jtag_slave_agent:rp_data -> router_006:sink_data
	...
	wire  [89:0] cmd_demux_001_src2_data;                                                            // cmd_demux_001:src2_data -> cmd_mux_002:sink0_data
	...
	wire  [89:0] cmd_demux_001_src3_data;                                                            // cmd_demux_001:src3_data -> cmd_mux_003:sink0_data
	...
	wire  [89:0] cmd_demux_001_src4_data;                                                            // cmd_demux_001:src4_data -> cmd_mux_004:sink0_data
	...
	wire  [89:0] rsp_demux_002_src0_data;                                                            // rsp_demux_002:src0_data -> rsp_mux_001:sink2_data
	...
	wire  [89:0] rsp_demux_003_src0_data;                                                            // rsp_demux_003:src0_data -> rsp_mux_001:sink3_data
	...
	wire  [89:0] rsp_demux_004_src0_data;                                                            // rsp_demux_004:src0_data -> rsp_mux_001:sink4_data
